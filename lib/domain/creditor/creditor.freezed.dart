...
mixin _$Creditor {
  ...
  String get informationUnstructured => throw _privateConstructorUsedError;
...
abstract class $CreditorCopyWith<$Res> {
  ...
  $Res call(
      ...
      String iban,
      String logo,
      String informationUnstructured,
      String country,
      String website,
      String phone,
      String email,
...
class _$CreditorCopyWithImpl<$Res> implements $CreditorCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? iban = freezed,
    Object? logo = freezed,
    Object? informationUnstructured = freezed,
    ...
    return _then(_value.copyWith(
      ...
      logo: logo == freezed
          ...
          : logo // ignore: cast_nullable_to_non_nullable
              as String,
      informationUnstructured: informationUnstructured == freezed
          ? _value.informationUnstructured
          : informationUnstructured // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_Creditor extends _Creditor {
  const _$_Creditor(
      {required this.id,
      required this.name,
      required this.iban,
      required this.logo,
      required this.informationUnstructured,
  ...
  final String logo;
  @override
  final String informationUnstructured;
  @override
  ...
  @override
  String toString() {
    return 'Creditor(id: $id, name: $name, iban: $iban, logo: $logo, informationUnstructured: $informationUnstructured, country: $country, website: $website, phone: $phone, email: $email, address: $address)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other.informationUnstructured, informationUnstructured) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(informationUnstructured),
...
abstract class _Creditor extends Creditor {
  const factory _Creditor(
      {required String id,
      required String name,
      required String iban,
      required String logo,
      ...
      required String phone,
      required String email,
      required String address}) = _$_Creditor;
  const _Creditor._() : super._();
  ...
  String get logo;
  @override
  String get informationUnstructured;
  @override
  String get country;
  @override
  String get website;
